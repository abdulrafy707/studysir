...
export default function TeacherCard({ teacher, baseUrl }) {
  ...
  return (
    <div className="flex justify-center">
      <div className="bg-white text-black border rounded-lg w-[300px] sm:w-[500px] md:w-[600px] p-4 gap-1 relative mx-auto" style={{ boxShadow: '-1px 1px 10px 0px #00000040' }}>
