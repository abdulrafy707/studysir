...
export default function WithdrawalRequest({ onClose }) {
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg relative">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-between">
          <button type="button" className="bg-gray-400 text-white px-4 py-2 rounded-lg hover:bg-gray-500" onClick={onClose}>
            Cancel
          </button>
