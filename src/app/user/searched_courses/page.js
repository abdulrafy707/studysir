  ...
  return (
    <div className="relative">
      ...
      {isLoading ? (
        ...
        /* Main Content */
        <div className="flex flex-wrap justify-center gap-6 text-black p-4">
          {courses.length === 0 ? (
            ...
            courses.map((course) => (
              <div 
                ...
                className="bg-white border z-10 rounded-lg w-[300px] sm:w-[300px] md:w-[600px] shadow-lg p-4 my-8 relative mx-auto"
              >
                {/* Join Request Popup */}
                ...
                <p className="text-gray-700 text-xs sm:text-sm mt-2">
                  ...
                  {course.description?.length > 100 && (
                    <button 
                      ...
                      className="text-blue-500 text-xs sm:text-sm ml-2"
                    >
